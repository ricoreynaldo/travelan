...
if (isset($_POST['Login'])){
	...
	$password=$_POST['password'];
		...
		$query=mysql_query($konek,"SELECT * FROM member WHERE username='$username' and password='$password'") or die(mysqli_error($konek));
...
?>
            <form name="Login" class="form-inline" action="login.php" method="post">
                <br><br>
